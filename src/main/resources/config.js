(function ($) {
    ...
    function saveConfig() {
        ...
        var requiredReviewers = $.grep($('#requiredReviewers').val().split(','), function (v) {
            return v != ''
        });
        var requiredReviewerGroups = $.grep($('#requiredReviewerGroups').val().split(','), function (v) {
            return v != ''
        });
        ...
        var getCheckboxValue = function (checkboxObject) {
            if (checkboxObject === 'undefined' || checkboxObject == null) {
                return false;
            }
            return !!checkboxObject.is(':checked')
        };
        ...
        var post = JSON.stringify({
            ...
            autoUnapprove: getCheckboxValue($('#autoUnapprove')),
            blockByRequiredReviewer: getCheckboxValue($('#blockByRequiredReviewer'))
        });
    ...
    function getConfig() {
        ...
        $.ajax({
            ...
            success: function (config) {
                ...
                var setCheckboxValue = function (checkoxObject, value) {
                  if(!!value){
                      checkoxObject.attr('checked', 'checked');
                  } else {
                        checkoxObject.removeAttr('checked');
                  }
                };
                ...
                setCheckboxValue($('#autoUnapprove'), config.autoUnapprove);
                setCheckboxValue($('#blockByRequiredReviewer'), config.blockByRequiredReviewer);
