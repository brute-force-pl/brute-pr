...
public class ConfigDao {
    ...
    public static final String AUTO_UNAPPROVE = "autoUnapprove";
    public static final String BLOCK_BY_REQUIRED_REVIEWER = "blockByRequiredReviewer";
    ...
    Config readConfig(PluginSettings settings) {
        return Config.builder()
                ...
                .autoUnapprove(Boolean.parseBoolean(get(settings, AUTO_UNAPPROVE, Boolean.FALSE.toString())))
                .blockByRequiredReviewer(Boolean.parseBoolean(get(settings, BLOCK_BY_REQUIRED_REVIEWER, Boolean.FALSE.toString())))
                .build();
    }
    ...
    void writeConfig(PluginSettings settings, Config config) {
        ...
        settings.put(BLOCK_BY_REQUIRED_REVIEWER, String.valueOf(config.getBlockByRequiredReviewer()));
        settings.put(AUTO_UNAPPROVE, String.valueOf(config.getAutoUnapprove()));
    }
    ...
    Config overlayConfig(Config bottom, Config top) {
        return Config.builder()
                ...
                // use always project settings
                .autoUnapprove(bottom.getAutoUnapprove())
                .blockByRequiredReviewer(bottom.getBlockByRequiredReviewer())
                .build();
    }

    /**
     * Reverses the overlay to retrieve only the top argument. Assumes that if any
