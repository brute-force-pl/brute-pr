...
public class Config {
    ...
    private Boolean blockByRequiredReviewer = false;
    private Boolean autoUnapprove = false;
    ...
    private Config(Builder builder) {
        ...
        setBlockByRequiredReviewer(builder.blockByRequiredReviewer);
        setAutoUnapprove(builder.autoUnapprove);
    }
    ...
    public Boolean getBlockByRequiredReviewer() {
        return blockByRequiredReviewer;
    }

    public void setBlockByRequiredReviewer(Boolean blockByRequiredReviewer) {
        this.blockByRequiredReviewer = blockByRequiredReviewer;
    }

    public Boolean getAutoUnapprove() {
        return autoUnapprove;
    }

    public void setAutoUnapprove(Boolean autoUnapprove) {
        this.autoUnapprove = autoUnapprove;
    }
    ...
    public static final class Builder {
        ...
        private Builder(Config copy) {
            ...
            blockByRequiredReviewer = copy.blockByRequiredReviewer;
            autoUnapprove = copy.autoUnapprove;
        }
        ...
        public Builder blockByRequiredReviewer(Boolean blockByRequiredReviewer) {
            this.blockByRequiredReviewer = blockByRequiredReviewer;
            return this;
        }

        public Builder autoUnapprove(Boolean autoUnapprove) {
            this.autoUnapprove = autoUnapprove;
            return this;
        }
