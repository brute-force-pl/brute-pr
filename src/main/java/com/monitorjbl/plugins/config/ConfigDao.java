...
public class ConfigDao {
    ...
    public static final String BLOCK_BY_DEFAULT_REVIEWER = "blockByDefaultReviewer";
    ...
    Config readConfig(PluginSettings settings) {
        return Config.builder()
                ...
                .blockByDefaultReviewer(Boolean.parseBoolean(get(settings, BLOCK_BY_DEFAULT_REVIEWER, Boolean.FALSE.toString())))
                .build();
    }
    ...
    void writeConfig(PluginSettings settings, Config config) {
        ...
        settings.put(BLOCK_BY_DEFAULT_REVIEWER, String.valueOf(config.getBlockByDefaultReviewer()));
    ...
    Config overlayConfig(Config bottom, Config top) {
        return Config.builder()
                ...
                .blockByDefaultReviewer(bottom.getBlockByDefaultReviewer())
                .build();
    }
